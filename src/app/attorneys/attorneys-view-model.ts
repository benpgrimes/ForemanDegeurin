...
const Bryan: Attorney = {
    ...
    biographyParagraphs: ['Bryan joined Foreman, DeGeurin & DeGeurin in 2012. His litigation practice focuses primarily on Texas state cases, both civil and criminal. Bryan has represented clients in State criminal cases ranging from drug possession to murder cases. Bryan also helps clients with administrative issues, and represents clients facing state or federal licensing issues.', 'Bryan graduated from the University of Houston Law Center in 2011. While in law school, Bryan worked with the Federal Public Defender’s office in Houston. He also interned with the Honorable Royal Furgeson in the U.S. District Court for the Western District of Texas.'],
